...
const Contact = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col gap-5 my-10 ">
      ...
      <div className="  text-white bg-opacity-30  bg-[#ff4b56] flex justify-center items-center flex-col  w-5/6 h-auto py-5 rounded-lg border border-[#ff4b56] font-para max-w-[60rem] md:w-4/6 lg:justify-around lg:flex-row">
        <form
        ...
        >
          ...
          <button className="text-lg bg-[#ff4b56] h-10 p-2 flex items-center justify-center  rounded-lg border border-[#ff4b56] hover:bg-transparent hover:text-white w-24 ">
            Send
          </button>
        </form>
        <img
